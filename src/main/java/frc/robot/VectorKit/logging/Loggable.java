...
public class Loggable {
    ...
    public void set(Object value) {
        ...
        if (setValError)
            DriverStation.reportError(String.format("[Error] VecKit: Failed to set value (%s:%s)", name, value), true);
    ...
    public void logUSB() {
        if (logEntry == null)
            DriverStation.reportError(
                    String.format("[Error] VecKit: Cannot USB Log topic (%s) (Invalid Type: %s)", name, type), true);
