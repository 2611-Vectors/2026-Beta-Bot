...
public class Transition extends SubsystemBase {
    ...
    //     LoggedNetworkNumber lowerRPM = new LoggedNetworkNumber("/Transition/Lower/Target RPM", 2000.0);
    //     LoggedNetworkNumber upperRPM = new LoggedNetworkNumber("/Transition/Upper/Target RPM", 2000.0);
